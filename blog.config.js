...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '190d7fe6d53e80589275c9fd082ae176',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hugo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hugok.blog', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Hugo, HugoK, Blog, Notion, 博客', // 网站关键词 英文逗号隔开
